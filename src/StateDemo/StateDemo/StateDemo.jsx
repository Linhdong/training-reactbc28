...
export default class StateDemo extends Component {
    //state: là các thuộc tính có sẵn của react class component, dùng để chứa các giá trị thay đổi trên giao diện. Khi state thay đổi thì giao diện sẽ tự render lại 
    state = {
        login: false
    }
    ...
    // handleLogin = async () => {
    handleLogin = () => {
        //Không được thay đổi state trực tiếp mà phải thông qya phương thức setState
        ...
        */
        ...
        this.setState({login: true
            ...
            //Hàm này sẽ tự gọi sai khi setState và render xong
